...
## Core principle: don't make Codex draw 1,700 icons

The expensive, wrong path is Codex generating icon components one by one, by
...
well-named components.** "Cheapest" is not just Codex tokens: a mechanism that
